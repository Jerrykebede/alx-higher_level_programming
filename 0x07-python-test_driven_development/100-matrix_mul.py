...
def matrix_mul(m_z, m_b):
    """Multiplies one matrix by another.
    Args:
        m_z: the first matrix
    ...
    if m_a_notnum:
        raise TypeError("m_a should cantain only integers or floats")

    if m_b_notnum:
        raise TypeError("m_b should cantain only integers or floats")
